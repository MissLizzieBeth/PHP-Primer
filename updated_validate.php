...
{
    "name": "HTML & Javascript Primer Exercise",
    "description": "A short description of your project: create the following Login Form using what I have learned in HTML & CSS.",
    "type": "project",
    "require": {},
    "authors": [
        {
            "name": "Elizabeth Rodriguez",
            "email": "elizabeth.rodriguez6@my.utsa.edu"
        }
    ],
